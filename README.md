...
```lua
-- Load icons
local Icons = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/ANHub-Script/Icons/main/Main.lua"))()
...
```lua
-- Load Icons
local Icons = loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/ANHub-Script/Icons/main/Main-v2.lua"))()
